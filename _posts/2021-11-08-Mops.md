...
layout: post
post-image: "../assets/images/pug.jpg"
...
{% figure caption:"**Abb. 1 :** Auges eines Mopses mit Keratitis pigmentosa, Schielstellung, schleimigem Ausfluss und viel zu großer Lidspalte sowie Härchen, die nasal auf dem Auge reiben." %}
![Mopsauge](../assets/images/Mops3.jpg)
{% endfigure %}
...
{% figure caption:"**Abb. 2 :** Vor der OP" %}
![Lidrandtumor-OP](../assets/images/mops1.png)
{% endfigure %}

{% figure caption:"**Abb. 3 :** Nach der OP. Nach der Operation ist die Lidspalte kleiner und die Augen deutlich besser geschützt. Es reiben keine Haare mehr auf der Hornhaut." %}
